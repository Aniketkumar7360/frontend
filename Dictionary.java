...
import java.io.PrintStream; import java.util.TreeMap;
...
public static String searchWord(String word)
...

    {
        ...
        {   System.out.println(dictionaryfile);
            ...
            FileOutputStream fs = new FileOutputStream(dictionaryfile); ObjectOutputStream os = new ObjectOutputStream(fs); os.writeObject(words); os.close(); fs.close(); modified = false;
