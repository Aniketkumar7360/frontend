...
public class AddWord extends JFrame
{
...

    {
        ...
        GridBagLayout gbl = new GridBagLayout(); GridBagConstraints gbc = new GridBagConstraints(); gbc.insets = new Insets(5, 5, 5, 5);

        gbc.fill = 1;

        this.tfWord = new JTextField(30);

        this.taMeaning = new JTextArea(); this.btnAdd = new JButton("Add Word");
...

        {
...

            {
                ...
                JOptionPane.showMessageDialog(AddWord.this, "Please enter word and meaning!", "Add Word",
        ...
        gbc.gridwidth = 2;
        gbc.gridheight = 2;
        this.taMeaning.setRows(3); this.taMeaning.setColumns(30);
